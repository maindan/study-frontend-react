...
export function Header({openLogin}: HeaderProps) {
    ...
    return(
        <header className="w-11/12 sm:w-6/12 border-1 border-white/10 rounded-2xl backdrop-blur-lg bg-white/5 h-17 flex items-center justify-between px-4 fixed top-0 left-1/2 -translate-x-1/2 mt-3 sm:mt-5 z-30">
